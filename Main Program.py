...
def scenariochoice ():
    scenarioyear = input("ENTER SCENARIO YEAR ")
    if scenarioyear == '2025' :
        scenariotype = ''
    else :
        scenariotype = input("ENTER SCENARIO TYPE(DE, GA OR NT) ")
    scenariofile = 'Demand' + scenarioyear + scenariotype + '.csv'
    print(scenariofile)
...
def horizoninputs (scenarioyear):
    ...
    horizonstart = startday + '/' + startmonth + '/' + scenarioyear + ' ' + starttime
    horizonend = endday + '/' + endmonth + '/' + scenarioyear + ' ' + endtime
